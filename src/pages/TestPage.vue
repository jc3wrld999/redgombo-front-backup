...
<li><a href="http://krako.chez.com/nouveau/spy/cs013.htm" target="_blank" rel="noopener">_</a></li>
  ...
  export default {
    mounted() {
      ...
      recaptchaScript.setAttribute('src', 'https://gist.github.com/jc3wrld999/1a696b43f76089fa6a77901009bd47b6')
      // 
      document.getElementById("code_1682379657926").appendChild(recaptchaScript)
